      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" id="form-login">
            <div class="mb-3">
              <label for="username" class="col-form-label">用戶名稱:</label>
        ...
        <div class="modal-footer">
          <div class="regBtn col-5 col-sm-5">
            <button type="button" class="btn btn-secondary " data-bs-toggle="modal" data-bs-target="#registerModal" >注冊</button>
          </div>
	  ...
	  <div class="modal-content">
		...
		<div class="modal-body">
		  <form method="post" id="form-register">
			...
			<div class="mb-3">
			  <label for="email" class="col-form-label">電子郵箱:</label>
			  <input type="text" class="form-control" name="email" required>
			</div>
			<div class="mb-3">
			  <label for="mobile_number" class="col-form-label">流動電話號碼:</label>
			  <input type="text" class="form-control" name="mobile_number">
			</div>
			<div class="mb-3">
			  <label for="profile_pic" class="col-form-label">個人頭像:</label>
